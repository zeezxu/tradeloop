  ...
  <div class="container">
    ...
    <div style="flex: 1; background-color: #f8f8f8">
      <div style="height: 50px; display: flex; align-items: center; background-color: white; padding-left: 20px">
        ...
        <span style="font-size: 24px; margin-left: 5px">TradeLoop Second-Hand Trading Platform</span>
      </div>
        ...
        <div style="width: 400px; padding: 40px; background-color: white; border-radius: 5px;">
          ...
          <el-form :model="form" :rules="rules" ref="formRef">
            ...
            <el-form-item prop="confirmPassword">
              <el-input size="medium" prefix-icon="el-icon-lock" placeholder="Please confirm password" show-password  v-model="form.confirmPassword"></el-input>
            </el-form-item>
            <el-form-item>
