  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe class="wrap-header-table" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="phone" label="Phone" width="130" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="email" label="Email" width="200" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="reply" label="Reply" width="250" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="createtime" label="Create Time" width="150" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="userName" label="User" width="120" align="center" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="Reply to Feedback" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        <el-form-item label="Reply" prop="reply">
          <el-input type="textarea" :rows="5" v-model="form.reply" placeholder="Enter your reply"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="fromVisible = false">Cancel</el-button>
        <el-button type="primary" @click="save">Send Reply</el-button>
      </div>
    </el-dialog>
      ...
      this.$refs.formRef.validate((valid) => {
        if (valid) {
          this.$request({
            ...
            if (res.code === '200') {
              this.$message.success('Reply sent successfully')
              this.load(1)
