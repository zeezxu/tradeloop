  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe class="wrap-header-table" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="title" label="Title" width="120" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column label="View Content" width="120" align="center">
        ...
        <el-table-column prop="userName" label="Author" width="120" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="Actions" align="center" width="300" fixed="right">
          <template v-slot="scope">
            <el-button size="mini" type="success" plain @click="changeStatus(scope.row, 'pass')">Approve</el-button>
    ...
    <el-dialog title="Post Information" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="120px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="Publish Time" prop="time">
          <el-input v-model="form.time" placeholder="Publish time"></el-input>
        </el-form-item>
        ...
        <el-form-item label="Status" prop="status">
          <el-select v-model="form.status" style="width: 100%" placeholder="Select status">
            <el-option value="pending" label="Pending Review"></el-option>
